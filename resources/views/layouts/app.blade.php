...
<body style="background:#e6ecf0">
    <div id="app">
        <nav style="background:#283e4a" class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container" style="color:white">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                              <a style="color:lightgray;  font-size: 1.2rem" class="navbar-brand" href="{{url('/chat')}}">
